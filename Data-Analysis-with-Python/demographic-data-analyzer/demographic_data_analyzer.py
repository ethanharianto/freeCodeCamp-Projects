...
def calculate_demographic_data(print_data=True):
    ...
    countries_population = df['native-country'].value_counts()
    countries_earning_over_50k = df[df['salary'] == '>50K']['native-country'].value_counts()

    highest_earning_country = (countries_earning_over_50k / countries_population).idxmax()
    highest_earning_country_percentage = (countries_earning_over_50k / countries_population).max() * 100
